 ...
 * @author USER
 */
public class formHomeScreen extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formHomeScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
